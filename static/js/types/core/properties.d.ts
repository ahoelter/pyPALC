...
export declare const LineCap: PropertyConstructor<CanvasLineCap>;
export declare const LineJoin: PropertyConstructor<CanvasLineJoin>;
...
export declare const TextBaseline: PropertyConstructor<CanvasTextBaseline>;
